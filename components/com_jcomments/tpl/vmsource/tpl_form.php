...
?>
<h4 class="product-section_title"><?php echo JText::_('FORM_HEADER'); ?></h4>
<?php if ($this->getVar( 'comments-form-policy', 0) == 1) { ?>
...
<div id="comments-form-buttons" class="form-group">
	<div id="comments-form-send">
		<a class="btn btn-default" href="#" tabindex="7" onclick="jcomments.saveComment();return false;" title="<?php echo JText::_('FORM_SEND_HINT'); ?>"><?php echo JText::_('FORM_SEND'); ?></a>
	</div>
	<div id="comments-form-cancel" style="display:none;">
		<a class="btn btn-default" href="#" tabindex="8" onclick="return false;" title="<?php echo JText::_('FORM_CANCEL'); ?>"><?php echo JText::_('FORM_CANCEL'); ?></a>
	</div>
