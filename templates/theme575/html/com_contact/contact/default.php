...
?>
<div class="page contact-view contact-view__<?php echo $this->pageclass_sfx?>">
<?php if ($this->params->get('show_page_heading')) : ?>
	<div class="page_heading contact_heading">
		<h1 class="page_title">
...
<?php endif; ?>
	...
	<?php if ($this->contact->name && $this->params->get('show_name')) : ?>
		<h2>
			<span class="contact_name"><?php echo $this->contact->name; ?></span>
		</h2>
	<?php endif;  ?>

	<?php if ($this->params->get('show_contact_category') == 'show_no_link') : ?>
		<h3>
			<span class="contact_category"><?php echo $this->contact->category_title; ?></span>
		</h3>
	<?php endif; ?>
	...
	<?php if ($this->params->get('show_contact_category') == 'show_with_link') : ?>
		...
		<h3>
			<span class="contact_category"><a href="<?php echo $contactLink; ?>">
	...
	<?php endif; ?>
		...
		<?php if ($this->contact->image && $this->params->get('show_image')) : ?>
			<div class="contact_image item_image">
				<?php echo JHtml::_('image', $this->contact->image, JText::_('COM_CONTACT_IMAGE_DETAILS'), array()); ?>
			</div>
		<?php endif; ?>

		<?php if ($this->contact->con_position && $this->params->get('show_position')) : ?>
			<h2 class="contact_position"><?php echo $this->contact->con_position; ?></h2>
		<?php endif; ?>
