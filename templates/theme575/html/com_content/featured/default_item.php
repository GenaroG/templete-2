...
<div class="view-heading-wrap">
	<?php if ($params->get('show_create_date')) : ?>
			<dd class="article_reate">
			<span class="date1"><?php echo JText::sprintf(JHtml::_('date', $this->item->created, 'd')); ?></span>
            <span class="date2"><?php echo JText::sprintf(JHtml::_('date', $this->item->created, '/')); ?></span>
            <span class="date3"> <?php echo JText::sprintf(JHtml::_('date', $this->item->created, 'm')); ?></span>
			</dd>
	<?php endif; ?>
...
<?php if (($params->get('show_author')) or ($params->get('show_category')) or ($params->get('show_create_date')) or ($params->get('show_modify_date')) or ($params->get('show_publish_date')) or ($params->get('show_parent_category')) or ($params->get('show_hits'))) : ?>
 <dl class="article_info">
	 <dt class="article_info-term"><?php  echo JText::_('COM_CONTENT_ARTICLE_INFO'); ?></dt>
	<?php endif; ?>

	<?php if ($params->get('show_parent_category') && $this->item->parent_id != 1) : ?>
			<dd class="article_parent-category-name">
