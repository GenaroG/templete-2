...
<div class="buttonBar-right user">
	<button class="button btn btn-primary" type="submit" onclick="javascript:return myValidator(userForm, 'saveUser');" ><?php echo $this->button_lbl ?></button>
	&nbsp;
	<button class="button reset btn btn-default" type="reset" onclick="window.location.href='<?php echo JRoute::_('index.php?option=com_virtuemart&view=user'); ?>'" ><?php echo vmText::_('COM_VIRTUEMART_CANCEL'); ?></button>
<div class="clear"></div>
</div>
<?php } ?>
