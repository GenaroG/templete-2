...
<section id="contact">
    ...
    <div class="container">
   <?php  $texthtml = $params->get('text-html');
   		echo '<div class="custom-contact-html">'.$texthtml.'</div>';
    ?>
    ...
    <div class="row">
		<!-- Name Field -->
		  <div class="col-md-4 col-lg-4 col-sm-12 control-group control-group-input <?php echo $params->get('errors_position');?>">
			<?php if(!$labels_pos) { ?>
		  ...
		  ?>
           <!-- Phone Field -->
            <?php 
				...
				{
		  ?>
		  <div class="col-md-12 col-lg-12 col-sm-12 control-group control-group-input <?php echo $params->get('errors_position');?>">
			<?php if(!$labels_pos) { ?>
		 ...
		 <!-- Submit Button -->
		  <div class="control-group control-group-button">
			<div class="controls">
			  ...
			  <button type="submit" name="button" value="Send" class="btn btn-default mod_tm_ajax_contact_form_btn"><?php echo $params->get('bs_name');?></button>
              <?php			
