		...
		<?php  $count=1; ?>
			...
			<div  class="products-listing listing__grid <?php echo 'owl-demo-'.$params->get ('moduleclass_sfx'); ?>">
				<div class="rows">
					...
					?>
						<div class="item item__product <?php if (abs($product->prices['discountAmount']) > 0 && ($product->prices['salesPrice'] < $product->prices['salesPriceWithDiscount'] ) ){ echo 'sale';} ?>	" style="<?php echo $pwidth; ?>">
...
jQuery(document).ready(function() {
	...
	jQuery('.mod_virtuemart_product .rows').addClass('wow zoomIn');
